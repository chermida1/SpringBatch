...
public class BatchConfiguration {
	...
	public JdbcBatchItemWriter<User> writer() {
		...
		writer.setSql("INSERT INTO USER (NAME,MOBILE) VALUES (:name,:mobile)");
	...
	@Bean
	public Step step1() {
		return stepBuilderFactory.get("step1").<User, User>chunk(3).reader(flatFileReader()).processor(processor())
				.writer(writer()).build();
	}
